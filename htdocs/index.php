...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputCpf" aria-describedby="emailHelp" placeholder="Digite o CPF" name="usercpf" onkeypress="$(this).mask('000.000.000-00')">
  </div>
